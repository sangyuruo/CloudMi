/*
package com.emcloud.mi.web.rest.service;
...
@SpringBootTest(classes = EmCloudMiApp.class)
@Transactional
public class Test {
...
//    }+
    ...
    public void findTree() {
        ...
        try {//查询所有菜单
            List<MeterInfo> allMenu = meterInfoRepository.findAllByComPointCode("102");

            Collections.sort(allMenu, new Comparator<MeterInfo>() {
                @Override
                public int compare(MeterInfo o1, MeterInfo o2) {
                    return o1.getMeterCode().compareTo(o2.getMeterCode());
                }

            });
            StringBuilder sb = new StringBuilder();
            MeterInfo preNav = null;

            for (MeterInfo nav : allMenu) {
